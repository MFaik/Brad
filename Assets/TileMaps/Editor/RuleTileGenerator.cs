...
{
    [MenuItem("Assets/EditorTools/Rule Tile from Sprite Sheet With Collision")]
    private static void CreateRuleTileFromSpriteSheetWithCollision() {
        CreateRuleTileFromSpriteSheet(true);
    }

    [MenuItem("Assets/EditorTools/Rule Tile from Sprite Sheet Without Collision")]
    private static void CreateRuleTileFromSpriteSheetWithoutCollision() {
        CreateRuleTileFromSpriteSheet(false);
    }

    private static void CreateRuleTileFromSpriteSheet(bool collisionActive) {
        ...
        foreach(var rule in ruleList){
            ...
            tilingRule.m_ColliderType = collisionActive ? UnityEngine.Tilemaps.Tile.ColliderType.Sprite : UnityEngine.Tilemaps.Tile.ColliderType.None; 
            ...
            fillerTilingRule.m_ColliderType = collisionActive ? UnityEngine.Tilemaps.Tile.ColliderType.Sprite : UnityEngine.Tilemaps.Tile.ColliderType.None; 
            ...
            centralTilingRule.m_ColliderType = collisionActive ? UnityEngine.Tilemaps.Tile.ColliderType.Sprite : UnityEngine.Tilemaps.Tile.ColliderType.None; 
    ...
    [MenuItem("Assets/EditorTools/Rule Tile from Sprite Sheet With Collision", true)]
    [MenuItem("Assets/EditorTools/Rule Tile from Sprite Sheet Without Collision", true)]
